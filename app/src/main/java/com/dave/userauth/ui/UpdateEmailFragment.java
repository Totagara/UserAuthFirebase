...
public class UpdateEmailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pictire_imageView = root.findViewById(R.id.image_view_pic);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(currentUser != null && currentUser.getPhotoUrl() != null){
            Picasso.get().load(currentUser.getPhotoUrl()).into(pictire_imageView);
        } else {
            Picasso.get().load(R.mipmap.ic_defaultprofilepic).into(pictire_imageView);
        }
